...
void main() {
  ...
  test('initial state should be [AuthentictionInitial', () async {
  ...
  group('createUser', () {
    ...
    blocTest<AuthenticationCubit, AuthenticationState>(
        'should emit [CreatingUser, AuthenticationError] when unsucessful',
        build: () {
          when(() => createUser(any())).thenAnswer(
  ...
  group('getUsers', () {
    blocTest<AuthenticationCubit, AuthenticationState>(
      'should emit [Getting, UserLoaded] when successful',
      build: () {
